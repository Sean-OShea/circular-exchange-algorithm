...
def generate_item(user_id):
    return {
        ...
        "value": fake.random_int(
            env.ITEMS["min_value"], env.ITEMS["max_value"], env.ITEMS["value_step"]
        ),
    }
...
def generate_user(items_number):
    ...
    return {"id": user_id, "name": fake.name(), "items_wishes_id": []}
...
for user in users:
    user["items_wishes_id"] = list(
        fake.random_elements(
            [item["id"] for item in items if item["user_id"] != user["id"]],
